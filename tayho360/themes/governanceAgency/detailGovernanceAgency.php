        ...
        <section id="map-section" class="mgt-80">
            <div class="container">
                <div class="title-section mgb-32">
                    <p>Bản đồ<?php  if(!empty($data->latitude) & !empty($data->longitude)){ ?>
                    <a target="_blank" href="https://www.google.com/maps/dir/<?php echo $data->latitude  ?>,+<?php echo $data->longitude  ?>/" style=" color: #188181; " title="Chỉ đường"><i class="fa-solid fa-map-location-dot"></i></a>
                <?php } ?></p>
                </div>
