        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link " href="/listCustomer" id="member">
                 Khách hàng
              </a>
            </li>
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="member">
                ...
                <a class="dropdown-item" href="/listWarehouse">Quản lý sách</a>   
                <a class="dropdown-item" href="/listbook">Đầu sách</a>
                ...
                <a class="dropdown-item" href="/listWarehouseHistory">Lịch sử nhập và hủy sách</a>
              </div>
            </li>
