...
<body>
    <!-----Header ----->
    <div class="relative min-h-screen bg-center bg-cover fade-in background-header"
        style="background-image: url('<?php echo $setting['background_image']; ?>')">
        <div class="background-overlay"></div>
        <div class="relative z-20">
            <header id="mainHeader"
                class="fixed top-0 left-0 right-0 z-50 py-4 px-4 sm:px-6 lg:px-20 bg-transparent font-plus transition-all duration-300">
                <div class="flex items-center justify-between font-bold">
                    <a href="/" class="flex items-center">
                        <img alt="Logo" class="mr-2" height="150" src="
                        <?php echo $setting['image_logo'] ?>
                        " width="150" />
                    </a>
                    <div class="items-center hidden space-x-2 lg:flex md:property-button lg:space-x-6 xl:space-x-16">
                        <nav id="nav-sectionpage"
              ...
              ?>
                            <div class="group">
                                ...
                                <?php else: ?>
                                <a href="<?php echo $categoryMenu['link']; ?>"
                                ...
                                <!-- Mega Menu Dropdown -->
                                <div
                                    class="absolute left-1/2 transform -translate-x-1/2 hidden pt-4 group-hover:block z-50">
                              ...
                              ?>
                                        ...
                                        <div class="grid grid-cols-<?php echo $gridCols; ?> gap-6">
                                            ...
                                            <div class="border-r border-gray-300 last:border-0 pr-6">
                                                <h4
                                                    class="font-bold !text-gray-900 pb-2 border-b border-gray-300 !text-[14px]">
                                                    <a href="<?php echo $subMenu['link']; ?>"
                                                        class="hover:!text-blue-500 transition duration-200 !text-gray-900">
