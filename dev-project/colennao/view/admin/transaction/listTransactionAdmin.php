      ...
      <div class="card-body">
        <div class="row gx-3 gy-2 align-items-center">
          ...
          <div class="col-md-3">
            ...
            <select name="type_transaction" class="form-select color-dropdown">
              <option value="">Tất cả</option>
              <option value="pay_real" <?php if(!empty($_GET['type_transaction']) && $_GET['type_transaction']=='pay_real') echo 'selected';?> >Hệ thống xử lý tự động</option>
              <option value="pay_admin" <?php if(!empty($_GET['type_transaction']) && $_GET['type_transaction']=='pay_admin') echo 'selected';?> >Admin kích hoạt </option>
            </select>
          </div>
