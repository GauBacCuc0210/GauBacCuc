                ...
                <div class="place-around-slide">
                    ...
                    <div class="place-around-slide-item">
                        <div class="place-around-img">
                            <a href="/chi_tiet_trung_tam_hoi_nghi_su_kien/<?php echo $value->urlSlug ?>.html"><img src="<?php echo $value->image ?>" alt=""></a>
                        </div>


                        <div class="place-around-title">
                            <a href="/chi_tiet_trung_tam_hoi_nghi_su_kien/<?php echo $value->urlSlug ?>.html"><?php echo $value->name ?></a>
                        </div>
