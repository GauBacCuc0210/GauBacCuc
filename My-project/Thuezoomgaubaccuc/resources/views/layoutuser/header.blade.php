...
<html lang="en">
  ...
  >
    ...
    <div class="flex h-screen overflow-hidden">
      ...
      @include('layoutuser.slidebaradmin')
  ...
  >
    ...
    >
      ...
      <div class="hidden lg:block">
        <form>
          <div class="relative">
            <span class="absolute top-2/3 left-4 -translate-y-1/2">
              <svg
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="{{ asset('images/pngtree-polar-bear-head-png-image_12164074.png')  }}" alt="User" />
          </span>

          <span class="text-theme-sm mr-1 block font-medium"> Nguyễn Việt Hoàng </span>
