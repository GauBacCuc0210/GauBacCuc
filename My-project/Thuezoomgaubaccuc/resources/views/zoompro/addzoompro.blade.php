            ...
            <div class="grid grid-cols-12 gap-4 md:gap-6">
                <div class="col-span-12 space-y-6 xl:col-span-12 ">
                    ...
                    <div class="bg-white p-4 rounded-md shadow">
                       ...
                       <form action="{{ route('zoompro.store') }}" method="POST">
                            @csrf <!-- Bảo vệ CSRF -->
                            ...
                            <div class="flex gap-4">
                                <div class="w-1/2 pt-2 mt-3">
                                    ...
                                    >
                                        ...
                                        <option value="300">300 người dùng</option>
                                        <option value="500">500 người dùng</option>
                                        <option value="1000">1000 người dùng</option>
                                    </select>
                                </div>
