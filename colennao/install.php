...
`type_transaction` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
`id_package` INT NOT NULL DEFAULT 0,
...
$sqlUpdateDatabase['transactions']['type_transaction'] = "ALTER TABLE `transactions` ADD `type_transaction` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;";
